...
func TestURL(t *testing.T) {
	...
	// Test show command
	url, err := client.URL(ctx, URLCommandShow, map[string]string{"id": "uuid"})
...
func TestAddProjectURL(t *testing.T) {
	...
	url := client.AddProjectURL(params)
...
func TestURLEncoding(t *testing.T) {
	...
	url, err := client.URL(ctx, URLCommandAdd, params)
	require.NoError(t, err)
...
func TestURLUpdate(t *testing.T) {
	...
	url, err := client.URL(ctx, URLCommandUpdate, map[string]string{
		"id":        "test-uuid",
		"completed": "true",
	})
	require.NoError(t, err)
